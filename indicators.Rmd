...
Now that we have an incicator of raised somatic cell count during lactation, it is easy to apply it to determine the incidence of raised somatic cell count during the dry period. We just have to put as a condition that `Dim < pDim`.
